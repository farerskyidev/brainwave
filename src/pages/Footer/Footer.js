            ...
            <ul className="gap-x-12 flex font-semibold justify-end">
                <li className='footer_icon'>
                  <a href="/">
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <g className='path_icon' clip-path="url(#clip0_447_25714)">
                ...
                <li className='footer_icon'>
                  <a href="/">
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect width="40" height="40" rx="20" fill="#15131D"/>
                      <g className='path_icon' clip-path="url(#clip0_447_25719)">
                ...
                <li className='footer_icon'>
                  <a href="/">
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect width="40" height="40" rx="20" fill="#15131D"/>
                      <g className='path_icon' clip-path="url(#clip0_447_25723)">
                ...
                <li className='footer_icon'>
                  <a href="/">
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect width="40" height="40" rx="20" fill="#15131D"/>
                      <g className='path_icon' clip-path="url(#clip0_447_25733)">
                ...
                <li className='footer_icon'>
                  <a href="/">
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect width="40" height="40" rx="20" fill="#15131D"/>
                      <g className='path_icon' clip-path="url(#clip0_447_25737)">
