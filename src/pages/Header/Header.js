        ...
        <div className="headerWrapper w-1920">
          <div className="grid-x grid-padding-x size-full items-center py-5 relative">
            ...
            <div className="cell large-9"> 
              <nav>
                <ul className="flex justify-end font-semibold menu items-center">
                  ...
                  <li className='text-whiteColor-50'> <NavLink className='text-xs font-semibold text-whiteColor-50' to="/new-account">New Account</NavLink> </li> 
                  <li className='text-whiteColor-50'><div className=" rounded-xl w-fit margin-a">
